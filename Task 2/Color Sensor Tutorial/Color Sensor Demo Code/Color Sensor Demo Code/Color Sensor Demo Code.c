...
#define F_CPU //define F_CPU value
#include <avr/io.h>
...
void color_sensor_pin_interrupt_init(void) //Interrupt 0 enable
{
	...
	EICRA =  // INT0 is set to trigger with falling edge
	EIMSK =  // Enable Interrupt INT0 for color sensor
	sei(); // Enables the global interrupt
}

//ISR for color sensor
ISR(INTn_vect) // Pass the timer number in place of n in INTn_vect
{
